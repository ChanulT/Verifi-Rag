...
from app.ingestion.schemas import Chunk, JobStatus
from app.libr.chunking import ChunkingService
from app.repositories.document import DocumentRepository       # keep for now or inline
from app.libr.qdrant import QdrantRepository
from app.shared.configs import settings_manager
from app.shared.utils import extract_document_date
